...
import com.architecture.genericarchitecture.enums.MessageCode;
...
public class BusinessException extends RuntimeException {
    ...
    public BusinessException(MessageCode error){
        ...
        messageResponse.getMessages().add(new Message((ApiErrorEnum) error));
    }
    ...
    public BusinessException(MessageCode error, String... params){
        ...
        messageResponse.setStatusCode(400);
        messageResponse.setMessages(new ArrayList<>());
        messageResponse.getMessages().add(new Message((ApiErrorEnum) error, params));
    }
